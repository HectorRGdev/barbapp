...
class Email{
    ...
    public function enviarConfirmacion(){
        ...
        $mail->setFrom('cuenta@barbapp.com', 'BarbApp');
        $mail->addAddress('demo@mailtrap.io', 'Barbapp.com');
        ...
        $contenido = "<html>";
        $contenido .= "<p><strong>Hola " . $this->email . "</strong> Has creado tu cuenta en Barbapp,
